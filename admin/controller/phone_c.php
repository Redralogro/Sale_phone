									...
									if ($this->phone->ComfirmOrder($id, 2) == 1) {
										...
										$mail = new PHPMailer(true);
											try {
												...
												$mail->CharSet = "UTF-8";
												// $mail ->charSet = "UTF-8"; //chữ c không viết hoa, lát test lại nhé
				...
				case 'addUser':
					if (isset($_POST['submit'])) {
						...
						$tmpFile = $_FILES["user"]["tmp_name"];
							...
							if($check_pass!=$pass){
								$_SESSION['errorPass']="Mật khẩu không trùng khớp !!!";
							}
							if
