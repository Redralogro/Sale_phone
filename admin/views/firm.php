<div class="container-fluid">
    ...
    ?>
    <h1>Danh sách điện thoại theo hãng</h1>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <?php
                    ...
                    echo "<div class='alert alert-info'>
            <a class='close' data-dismiss='alert'>&times;</a>
            <strong>Nhắc nhở!</strong> Hãng này chưa có sản phẩm.
          </div>";
                } 
            ?>
            
        </tbody>
        <a href="index.php?method=listfirm">
            <button type="button" class="btn alert-success">Quay lại </button>
        </a>
    </table>
